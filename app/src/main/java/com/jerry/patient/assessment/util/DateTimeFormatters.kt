...
val READABLE_TIME_PATTERN_PARSER: DateTimeFormatter = DateTimeFormatter.ofPattern(
    READABLE_TIME_PATTERN,
    Locale.US
).withZone(ZoneOffset.systemDefault())

val READABLE_DATE_TIME_PATTERN_PARSER: DateTimeFormatter = DateTimeFormatter.ofPattern(
